...
{
  if(self = [super init]) {
    NSRect contentSize = NSMakeRect(30, 40, 30, 40); // initial size of main NSWindow
    ...
    [windowController setWindowFrameAutosaveName:@"helpscoutStats"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit helpscoutStats" action:@selector(terminate:) keyEquivalent:@"q"];
